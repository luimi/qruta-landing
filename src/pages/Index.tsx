      ...
      <footer className="bg-primary text-white py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center text-gray-300">
            <p>&copy; 2025 Q'ruta. Todos los derechos reservados. <a href='/privacy-policies'>Política de privacidad</a> y <a href='/terms-conditions' target="_blank">condiciones de uso</a></p>
          </div>
        </div>
      </footer>
